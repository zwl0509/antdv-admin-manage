<template>
  <div class="main user-layout-register">
    ...
    <a-form ref="formRegister" :form="form" id="formRegister">
      ...
      <a-form-item>
        <a-input size="large" placeholder="11 位手机号" maxLength="11" v-decorator="['mobile', {rules: [{ required: true, message: '请输入正确的手机号', pattern: /^1[3456789]\d{9}$/ }], validateTrigger: ['change', 'blur'] }]">
      ...
      <a-row :gutter="16">
        <a-col class="gutter-row" :span="16">
          <a-form-item>
            <a-input size="large" type="text" placeholder="验证码" maxLength="30" v-decorator="['captcha', {rules: [{ required: true, message: '请输入验证码' }], validateTrigger: 'blur'}]">
  ...
  methods: {
    ...
    requestFailed (err) {
      this.$notification['error']({
        ...
        description: ((err.response || {}).data || {}).message || '请求超时，请稍后再试',
        duration: 4
      })
