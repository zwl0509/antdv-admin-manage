<template>
  ...
  >
    <a-spin :spinning="confirmLoading">
      <!--<a-collapse v-model="activeKey" expandIconPosition="right" v-if="visible">-->
      <!--  <a-collapse-panel v-for="(type_item, type_index) in authData" :key="type_item.type">-->
      <!--    <template slot="header">-->
      <!--      <div style="display:inline-block;line-height: 16px;">-->
      <!--        <span>{{ type_item.typeName }}</span><br />-->
      <!--      </div>-->
      <!--    </template>-->
      <s-table
        ref="table"
