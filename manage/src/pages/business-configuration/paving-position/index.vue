  ...
  <div>
    ...
    >
      ...
      <template slot="$operate">
        <a-button type="primary" icon="plus" @click="$refs.createModal.add()" v-if="actionAuth.includes('PavingPosition.Create')">新建</a-button>
      </template>
      <span slot="action" slot-scope="text, record">
        <template v-if="actionAuth.includes('PavingPosition.Modify')">
          <a @click="handleEdit(record)">编辑</a>
          <a-divider v-if="actionAuth.includes('PavingPosition.Delete')" type="vertical"/>
        </template>
        <template v-if="actionAuth.includes('PavingPosition.Delete')">
