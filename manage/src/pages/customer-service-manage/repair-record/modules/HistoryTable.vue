...
<script>
  ...
  import HistoryDetail from '@/pages/customer-service-manage/repair-record/modules/HistoryDetail'
  import { defaultTableColumns } from '@/components/ListPage/_utils'
  import DispatchOrder from '@/pages/customer-service-manage/repair-record/modules/DispatchOrder'
  import json from '@/pages/customer-service-manage/complaint-record/modules/mocks'
  import labels from '@/utils/labels'
  export default {
    name:'HistoryTable',
    components: { DispatchOrder ,HistoryDetail ,Ellipsis},
    props: {
      type: {
        type: String,
        default: '',
