<template>
  <div>
    <a-form :form="form">
      <a-row :grabbed="48">
        ...
        <a-col :md="8" :xs="24">
          <a-form-item label="报修来源" :labelCol="labelCol" :wrapperCol="wrapperCol">
            <a-select allowClear placeholder="请选择报修来源" :disabled="type == 'detail'" v-decorator="['recordSource', {rules: [{required: true}]}]">
              <a-select-option
      ...
      <a-row>
        <a-col :md="24" :xs="24">
          <a-form-item label="报修类别" :labelCol="labelCol" :wrapperCol="wrapperCol" class="col-1-9" >
            <a-select
              showArrow
              allowClear
              show-search
              ...
              placeholder="请选择报修类别"
              :disabled="type == 'detail'"
              v-decorator="['recordTypes',{ rules : [{ required: true, message: '请选择报修类别!'}]}]">
              <a-select-option
