  ...
  <a-modal
    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-col :md="12" :sm="24" v-if="isStatus">
        ...
        <a-col :md="12" :sm="24" v-if="isStatus && isCheckEmployee">
        ...
        <a-col :md="24" :sm="24">
          <a-form-item label="审核内容" :labelCol="labelCol1" :wrapperCol="wrapperCol1">
            <a-textarea
              placeholder="请输入审核内容"
              :rows="3"
    ...
    methods: {
      ...
      getCodeList() {
        ...
        this.$getCodesList(params, res => {
          ...
          // 过滤
          const filterList = ['1033-70','1033-90']
