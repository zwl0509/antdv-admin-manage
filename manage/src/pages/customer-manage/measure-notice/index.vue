  ...
  <div>
    ...
    <list-page
      ...
      <span slot="action" slot-scope="text, record">
        ...
        <template>
          <a @click="$refs.NoticeDetails.show(record.id)">详情</a>
          <a-divider type="vertical"/>
        </template>
        <template>
    ...
    <notice-details ref="NoticeDetails"></notice-details>
  </div>
</template>
...
<script>
  ...
  import NoticeDetails from '@/pages/customer-manage/measure-notice/modules/NoticeDetails'
