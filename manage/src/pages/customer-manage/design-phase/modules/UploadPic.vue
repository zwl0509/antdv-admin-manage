...
<script>
  ...
  import BaseInfo from '../../agreement-common-sea-pool/modules/BaseInfo.vue'
  import OtherInfo from '../../agreement-common-sea-pool/modules/OtherInfo.vue'
  import ProjectMenber from '../../agreement-common-sea-pool/modules/ProjectMenber.vue'
  import { defaultErrorMessage } from '@/utils/common'
  export default {
    components: { BaseInfo, ProjectMenber, OtherInfo },
    name: 'UploadPic',
    data () {
      return {
        type: '',
      ...
      getDetail(customerId,workFlowNodeId){
        ...
        this.$get({
          ...
          this.$refs.OtherInfo.setData({ 
            ...
            UploadPic: this.formType == '1059-50' ? true : false
          },data.relateEmployeeInfo, data.id)
