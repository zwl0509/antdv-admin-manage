z<template>
	<view class="u-select">
		...
		<u-popup :maskCloseAble="maskCloseAble" mode="bottom" border-radius="20"  :popup="false" v-model="value" length="auto" :safeAreaInsetBottom="safeAreaInsetBottom" @close="close" :z-index="uZIndex">
			<view class="u-select">
				<view class="u-select__header" @touchmove.stop.prevent="" style="height: 111rpx;border-radius: 20rpx 20rpx 0 0;">
					<view
					...
					<view class="u-select_search" v-if="title==''&&isSearch">
						<u-search placeholder="请输入" v-model="searchKeyword" :clearabled="false" :show-action="false" @change="search" ></u-search>
					</view>
					<view
