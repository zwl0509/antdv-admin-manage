<template>
	<view v-if="visibleSync" :style="[customStyle, {
		...
		<view
			...
			:style="[style]"
		>
			<view class="u-mode-center-box" @tap.stop.prevent @touchmove.stop.prevent v-if="mode == 'center'" :style="[centerStyle]" :class="{'no-bg-color':noBgColor}">
				<u-icon
					@click="close"
					v-if="closeable"
					class="u-close"
...
export default {
	...
	computed: {
		...
		centerStyle() {
			...
			style.maxHeight = this.maxHeight ? this.getUnitValue(this.maxHeight) : '';
			style.zIndex = this.uZindex;
