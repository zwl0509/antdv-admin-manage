	...
	<view class="u-search" @tap="clickHandler" :style="{
		...
		>
			<view class="u-icon-wrap">
				<u-icon class="u-clear-icon" :size="30" :name="searchIcon" :color="searchIconColor ? searchIconColor : color" v-if="uIconShow"></u-icon>
				<image :src="mImage" mode="" v-else style="width: 28rpx;height: 28rpx;"></image>
			</view>
			<input
				confirm-type="search"
				@blur="blur"
