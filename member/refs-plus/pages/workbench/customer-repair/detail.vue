<template>
	<view class="detail">
		<u-navbar title="报修详情" :border='false' :titleBold='true' :border-bottom="false" class="navbar"
			title-color='#333333'>
		...
		<view class="handle-info">
			<view class="handle-info-y">
				...
				<view class="handle-info-y-r" v-if="detail.dispatchInfos">
		...
		<view class="" v-if="detail.dispatchInfos&&role==1">
