<template>
	<view class="">
		...
		<view class="" style="padding: 30rpx;" v-if="!imgs.length">
			<u-upload ref="uUpload" width="196rpx" height="196rpx" :action="action" :formData="{attachType: '1009-20'}"
				:header="header" name="files" :auto-upload="false" max-count="6" :custom-btn="true"
		...
		<view class="btn" @click="submit()" v-if="!imgs.length">
			<text>确定</text>
		</view>
	</view>
</template>
